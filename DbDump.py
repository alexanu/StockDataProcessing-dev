...
# создаем таблицу с названием инструмента для свечей
...
while date < dateStop - timedelta(seconds=step):
    ...
    # скачиваем свечи за период step

    if len(data.get('candles')) > 0:

        # создаем шаблон для вставки в БД
        ...
        for candle in data.get('candles'):
            ...
            if last_id != datetime.min:
                ...
                print('Adding missing dates', md)

                # проблема - не выходит из while
